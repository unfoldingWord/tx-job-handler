...
def run_job(repo_name, owner='unfoldingWord', ref=None, dcs_domain='git.door43.org', input_format=None, project_ids=[], output_file=None, upload=True, subject=None):
    ...
    if len(orig_pdf_files) < 1 or (len(orig_pdf_files) > 2 and len(orig_pdf_files) != 67):
        data = {
            ...
            "resource_type": "TSV Translation Notes",
