...
TSV_TRANSLATION_QUESTIONS = "TSV ranslation Questions"
...
REQUIRED_RESOURCES = {
    ...
    OBS_TRANSLATION_NOTES: [OPEN_BIBLE_STORIES, TRANSLATION_WORDS],
    ...
    TSV_TRANSLATION_NOTES: [ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TRANSLATION_ACADEMY,
                            TRANSLATION_WORDS, TSV_TRANSLATION_WORDS_LINKS],
    TSV_TRANSLATION_QUESTIONS: [ALIGNED_BIBLE],
