...
SUBJECT_ALIASES = {
  ALIGNED_BIBLE: [ALIGNED_BIBLE, ALIGNED_BIBLE.replace(" ", "_"), 'ult', 'ust'],
  BIBLE: [BIBLE, BIBLE.replace(" ", "_"), 'usfm', 'bible'],
...
REQUIRED_RESOURCES = {
    ...
    OBS_STUDY_NOTES: [OPEN_BIBLE_STORIES, OBS_STUDY_QUESTIONS],
    ...
    TRANSLATION_NOTES: [ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TRANSLATION_ACADEMY, TRANSLATION_WORDS],
    TRANSLATION_QUESTIONS: [BIBLE],
    TRANSLATION_WORDS: [TRANSLATION_ACADEMY],
    TSV_TRANSLATION_NOTES: [ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TRANSLATION_ACADEMY, TRANSLATION_WORDS],
    TSV_STUDY_NOTES: [ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TSV_STUDY_QUESTIONS],
    TSV_STUDY_QUESTIONS: [ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT],
}
