...
TSV_OBS_TRANSLATION_NOTES = "TSV OBS Translation Notes"
TSV_OBS_TRANSLATION_QUESTIONS = "TSV OBS Translation Questions"
TSV_OBS_TRANSLATION_WORDS_LINKS = "TSV OBS Translation Words Links"
...
SUBJECT_ALIASES = OrderedDict({
  ...
  TRANSLATION_QUESTIONS: [TRANSLATION_QUESTIONS, TRANSLATION_QUESTIONS.replace(" ", "_")],
  TRANSLATION_WORDS: ["tw", TRANSLATION_WORDS, TRANSLATION_WORDS.replace(" ", "_")],
  TSV_OBS_TRANSLATION_NOTES: ["obs-tn", TSV_OBS_TRANSLATION_NOTES, TSV_OBS_TRANSLATION_NOTES.replace(" ", "_"), "Open Bible Translation Notes"],
  ...
  TSV_OBS_TRANSLATION_QUESTIONS: ["obs-tq", TSV_OBS_TRANSLATION_QUESTIONS, TSV_OBS_TRANSLATION_QUESTIONS.replace(" ", "_"), "Open Bible Translation Notes"],
  TSV_OBS_TRANSLATION_WORDS_LINKS: ["obs-twl", TSV_OBS_TRANSLATION_WORDS_LINKS, TSV_OBS_TRANSLATION_WORDS_LINKS.replace(" ", "_"), "Open Bible Translation Notes"],
  TSV_TRANSLATION_NOTES: ["tn", TSV_TRANSLATION_NOTES, TSV_TRANSLATION_NOTES.replace(" ", "_")],
  TSV_TRANSLATION_QUESTIONS: ["tq", TSV_TRANSLATION_QUESTIONS, TSV_TRANSLATION_QUESTIONS.replace(" ", "_")],
...
REQUIRED_RESOURCES = {
    ...
    OBS_TRANSLATION_NOTES: [OPEN_BIBLE_STORIES, TRANSLATION_ACADEMY, TRANSLATION_WORDS, OBS_TRANSLATION_QUESTIONS],
    OBS_TRANSLATION_QUESTIONS: [OPEN_BIBLE_STORIES],
    OPEN_BIBLE_STORIES: [],
    STUDY_NOTES: [ALIGNED_BIBLE, STUDY_QUESTIONS],
    STUDY_QUESTIONS: [ALIGNED_BIBLE],
    ...
    TRANSLATION_NOTES: [ALIGNED_BIBLE, ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TRANSLATION_ACADEMY,
                        TRANSLATION_WORDS, TSV_TRANSLATION_WORDS_LINKS],
    TRANSLATION_QUESTIONS: [BIBLE],
    TRANSLATION_WORDS: [TRANSLATION_ACADEMY],
    TSV_OBS_TRANSLATION_NOTES: [OPEN_BIBLE_STORIES, TSV_OBS_TRANSLATION_QUESTIONS, TSV_OBS_TRANSLATION_WORDS_LINKS, TRANSLATION_ACADEMY, TRANSLATION_WORDS],
    TSV_OBS_TRANSLATION_QUESTIONS: [OPEN_BIBLE_STORIES],
    TSV_OBS_TRANSLATION_WORDS_LINKS: [OPEN_BIBLE_STORIES, TRANSLATION_WORDS],
    TSV_TRANSLATION_NOTES: [ALIGNED_BIBLE, ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TRANSLATION_ACADEMY,
                            TRANSLATION_WORDS, TSV_TRANSLATION_WORDS_LINKS],
    TSV_TRANSLATION_QUESTIONS: [ALIGNED_BIBLE, ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT],
    TSV_STUDY_NOTES: [ALIGNED_BIBLE, ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TSV_STUDY_QUESTIONS, TSV_TRANSLATION_WORDS_LINKS],
    TSV_STUDY_QUESTIONS: [ALIGNED_BIBLE, ALIGNED_BIBLE, HEBREW_OLD_TESTAMENT, GREEK_NEW_TESTAMENT, TSV_TRANSLATION_WORDS_LINKS],
}
